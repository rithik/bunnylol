async function bunnylol(currCmd){
    ...
    const ghCmd = cmd(currCmd, "gh", "https://github.com/", "https://www.github.com/search?q=", false);
    const redditCmd = cmd(currCmd, "r", "https://reddit.com/", "https://www.reddit.com/search?q=", false);
    const googleCmd = cmd(currCmd, "g", "https://google.com/", "https://www.google.com/search?q=", false);
    
    return fbCmd || gmailCmd || sisCmd || collabCmd || youtubeCmd || ghCmd || redditCmd || googleCmd;
}
