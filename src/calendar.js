...
export type ClassCommands = "priv" | "sts" | "startup" | "ml" | "db" | "cloud";

export type JoinOrDiscussType = "j" | "d";
...
export const nextClass: (classCmd: ClassCommands, cmd: JoinOrDiscussType) => ?string = function(classCmd, cmd){
